...
// fn new_statsd_client() -> dogstatsd::Client {
//     let statsd_addr = std::env::var("STATSD_ADDR").expect("expecting STATSD_ADDR env var");
//     let opts = dogstatsd::Options::new("127.0.0.1:7654", &statsd_addr, "pitaya_rs_example");
//     dogstatsd::Client::new(opts).expect("failed to start datadog client")
// }
