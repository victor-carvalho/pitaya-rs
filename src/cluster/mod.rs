...
pub use discovery::Notification;
pub use rpc_server::Rpc;

// pub struct EtcdNatsCluster {
//     service_discovery: discovery::EtcdLazy,
//     client: rpc_client::NatsClient,
//     server_connection: Option<rpc_server::NatsServerConnection>,
//     server_connection_task: Option<task::JoinHandle<()>>,
// }

// impl EtcdNatsCluster {
//     pub fn new(
//         service_discovery: discovery::EtcdLazy,
//         client: rpc_client::NatsClient,
//         server_connection: rpc_server::NatsServerConnection,
//     ) -> Self {
//         Self {
